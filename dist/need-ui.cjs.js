...
var aside = vue.defineComponent({
  ...
  setup() {
    ...
    return () => vue.createVNode("div", {
      ...
      default: () => [vue.createTextVNode("11")]
    })]);
  }
  ...
  render() {
    return vue.createVNode(vue.Teleport, {
      ...
      default: () => [vue.createVNode(vue.Transition, {
        ...
        default: () => [this.modelValue ? vue.createVNode("div", {
        ...
        }, [this.$slots.title ? vue.renderSlot(this.$slots, 'title') : '提示']), vue.createVNode("div", {
          "class": 'dialog-content px-4'
        }, [this.$slots.default ? vue.renderSlot(this.$slots, 'default') : 'content']), vue.createVNode("div", {
...
var index = vue.defineComponent({
  ...
  render() {
    ...
    }, [this.$props.list.map(item => vue.createVNode("li", {
    ...
    }, [item.content]), item.id % 3 ? vue.createVNode("div", {
    ...
    }, [vue.createVNode("span", null, [item.time])])]))]);
  }
...
var loading = vue.defineComponent({
  ...
  render() {
    const props = this.$props;
    return vue.createVNode(vue.Fragment, null, [vue.renderSlot(this.$slots, 'default'), vue.createVNode("div", {
      "ref": 'obs',
  ...
  render() {
    ...
    return vue.createVNode(vue.Teleport, {
      ...
      default: () => [vue.createVNode(vue.Transition, {
        ...
        default: () => [props.show && vue.withDirectives(vue.createVNode("div", {
...
const Navbar = vue.defineComponent({
  ...
  setup() {
    const slideBooleanList = vue.reactive([]);
...
function createTree(tree) {
  ...
  return vue.createVNode(vue.Fragment, null, [tree.map((item, index) => {
    ...
    }, [item.name]), item.children ? vue.createVNode("ul", {
    ...
    }, [item.children.map(c => vue.createVNode("li", {
...
const Sidebar = vue.defineComponent({
  name: 'Sidebar',
  props: {
    category: {
      type: [],
  ...
  render() {
    ...
    return vue.createVNode(vue.Teleport, {
      ...
      default: () => [vue.createVNode(vue.Transition, {
        ...
        default: () => [vue.withDirectives(vue.createVNode("aside", {
...
const renderCategory = function () {
  const props = this.$props;
  return vue.createVNode(vue.Fragment, null, [props.category.map((item, index) => vue.createVNode("li", {
...
const MOBILE = 480;
const useResize = () => {
  const isMobile = vue.ref(isMobileHandle());
...
var Skeleton = vue.defineComponent({
  ...
  render() {
    ...
    const renderContent = () => {
      return new Array(props.rows).fill(1).map((r, index) => vue.createVNode("div", {
    ...
    const renderImage = () => {
      return props.image ? vue.createVNode("div", {
    ...
    const renderTime = () => {
      return props.time ? vue.createVNode("div", {
        "class": 'skeletion-item bg-gray-100 h-2 w-28 mt-1 md:h-3 md:mt-2 dark:bg-themebgcolor-500'
      }, null) : null;
    };

    return vue.createVNode(vue.Fragment, null, [props.loading ? new Array(props.items).fill(1).map(() => vue.createVNode("div", {
      "class": 'skeleton p-4 animate-pulse'
    }, [renderTitle(), vue.createVNode("div", {
      "class": 'skeleton-content flex'
    }, [vue.createVNode("div", {
      "class": 'skeleton-main flex-1'
    }, [renderContent()]), renderImage()]), renderTime()])) : vue.renderSlot(this.$slots, 'default')]);
  }
...
var input = vue.defineComponent({
  ...
  setup(props, {
    ...
    const show = vue.ref();
    const isFocus = vue.ref();
    const isShow = vue.computed(() => {
      return Boolean(props.modelValue) && Boolean(show.value);
    }); // 注入 form item

    const formItem = vue.inject('formItemProvide'); // 触发 form item 的效验方法
    ...
    const renderPrefixIcon = () => {
      ...
      if (slots.prefix) return vue.createVNode("span", {
    ...
    const renderSuffix = () => {
      if (props.clearable) return vue.createVNode(vue.Transition, {
    ...
    return () => vue.createVNode("div", {
    ...
    }, [renderPrefixIcon(), vue.withDirectives(vue.createVNode("input", {
      ...
      "onFocus": inputFocus,
      "onBlur": inputBlur
    }, null), [[vue.vModelDynamic, props.modelValue]]), renderSuffix()]);
  }
...
const FormItem = vue.defineComponent({
  ...
  setup(props, {
    ...
    const formProp = vue.inject(key);
    const emitter$1 = mitt();
    const isRequired = vue.ref(false); // 遍历判断是否 required 添加样式
    ...
    const formItemProvide = vue.reactive({ ...vue.toRefs(props),
      emitter: emitter$1,
      validate
    }); // 通过 provide 注入 当前组件的 props 及方法

    vue.provide('formItemProvide', formItemProvide); // label 属性
    ...
    return () => vue.createVNode(vue.Fragment, null, [vue.createVNode("div", {
    ...
    }, [vue.createVNode("label", vue.mergeProps(renderLabelAttr(), {
    ...
    }, [vue.renderSlot(slots, 'default'), vue.createVNode(vue.Transition, {
      ...
      default: () => [isError.value ? vue.createVNode("span", {
...
var footer = vue.defineComponent({
  ...
  render() {
    return vue.createVNode(vue.Fragment, null, [vue.createVNode("footer", {
...
var scroll = vue.defineComponent({
  name: 'Scroll',
  props: {
    height: {
      type: String,
  ...
  render() {
    ...
    return vue.createVNode(vue.Fragment, null, [vue.createVNode("div", {
      ...
      "ref": 'main'
    }, [vue.renderSlot(this.$slots, 'default')])]), vue.createVNode("div", {
